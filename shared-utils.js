/* 🚀 IMBRIANI NOLEGGIO - Shared Utilities v6.0 - CORS-Safe Enhanced */
...
async function callAPI(action, params = {}, method = 'GET') {
  ...
  const url = `${APP_CONFIG.API_BASE_URL}?${queryParams.toString()}`;
...
if (APP_CONFIG.DEBUG) {
  console.log('%c🚀 Shared Utils v6.0 loaded (CORS-Safe Enhanced)', 'color: #22c55e; font-weight: bold;');
}