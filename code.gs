/**
 * IMBRIANI STEFANO NOLEGGIO - BACKEND v8.3.7 (completo)
 * - GET: health, getVeicoli, getPrenotazioni, checkDisponibilita, updateStatiLive, getSheet, sincronizzaClienti
 * - POST: login, getPrenotazioni, getVeicoli, creaPrenotazione, aggiornaStato (se definita), setManutenzione (se definita), aggiornaCliente
 */
