 ...
 * - FEAT: Formattazione date italiane in tutte le risposte API
 * - FIX: updateStatiLive con logica corretta transizioni stati
 * - FEAT: getPrenotazioni con TUTTI i campi dettagliati
...
function versionInfo(){
  return {
    ...
    features: [
      ...
      'aggiornaStatoPrenotazione','booking_id_dinamico_anno','date_format_italian'
    ],
...
function doPost(e){
  ...
  try{
    ...
    switch(action){
      ...
      case 'checkReminders': return checkReminderEmails();
      case 'assegnaId': return assegnaIdPrenotazioniEsistenti();
      case 'confermaPrenotazione': return confermaPrenotazione(post);
...
// ═══════════════════════════════════════════════════════════════
// GET PRENOTAZIONI - VERSIONE COMPLETA CON DATE FORMATTATE
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// UPDATE STATI LIVE - FIX LOGICA TRANSIZIONI
// ═══════════════════════════════════════════════════════════════
