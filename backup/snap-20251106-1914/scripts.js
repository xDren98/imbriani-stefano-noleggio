// BACKUP SNAPSHOT: scripts.js v10.0 as of 2025-11-06 18:17
// Flusso unificato homepage: guest users + logged users
(function(){
      ...
      try{
        ...
        api.call({ action:'login', codiceFiscale: cf }).then(res => {
          ...
          if (window.showToast) {
            ...
            setTimeout(() => { window.location.href = 'area-personale.html'; }, 1200);
          } else {
            alert('Login ok'); window.location.href = 'area-personale.html';
          }
        }).catch(err => {
