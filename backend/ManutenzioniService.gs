...
function setManutenzione(post) {
  try {
    ...
    var values = [];
    values[CONFIG.MANUTENZIONI_COLS.TARGA - 1] = targa;
    values[CONFIG.MANUTENZIONI_COLS.MARCA - 1] = marca;
    values[CONFIG.MANUTENZIONI_COLS.MODELLO - 1] = modello;
    values[CONFIG.MANUTENZIONI_COLS.POSTI - 1] = posti || 9;
    values[CONFIG.MANUTENZIONI_COLS.STATO - 1] = stato || 'Programmata';
    ...
    values[CONFIG.MANUTENZIONI_COLS.NOTE - 1] = note || '';
